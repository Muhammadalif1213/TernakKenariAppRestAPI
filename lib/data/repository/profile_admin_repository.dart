...
import 'package:rest_api/data/models/request/admin/admin_profile_request.dart';
import 'package:rest_api/data/models/response/admin_profile_response_model.dart';
...
class ProfileAdminRepository {
  ...
  Future<Either<String, AdminProfileResponseModel>> addProfile(
      AdminProfileRequestModel requestModel) async {
    try {
